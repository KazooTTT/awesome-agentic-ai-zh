...
- Stage 3 用三语图教第一个 Agent Loop；Stage 4 用 framework 教 Workflow Graph；Stage 7 再把两者提升为 Loop／Graph Engineering。Stage 6 重画两条路的 RAG pipeline；Stage 8 补上界面选择与安全检查图。
