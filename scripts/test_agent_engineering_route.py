...
GLOSSARY_MARKERS = {
    "zh-TW": (
        ...
        "課程會依序教 [Stage 3 的 Agent Loop](../stages/03-tool-use-and-hello-agent.md) → [Stage 4 的 Workflow Graph／Agent Framework](../stages/04-agent-frameworks.md) → [Stage 7 的 Loop／Graph Engineering：讓 Agent 穩定運作](../stages/07-multi-agent-production.md)",
    ...
    "en": (
        "### Agent Production Engineering",
        "the course teaches [Stage 3 Agent Loop](../stages/03-tool-use-and-hello-agent.en.md) → [Stage 4 Workflow Graph / Agent Framework](../stages/04-agent-frameworks.en.md) → [Stage 7 Loop & Graph Engineering: Making Agents Reliable](../stages/07-multi-agent-production.en.md)",
    ...
    "zh-Hans": (
        "### Agent Production Engineering",
        "课程会依序教 [Stage 3 的 Agent Loop](../stages/03-tool-use-and-hello-agent.zh-Hans.md) → [Stage 4 的 Workflow Graph／Agent Framework](../stages/04-agent-frameworks.zh-Hans.md) → [Stage 7 的 Loop／Graph Engineering：让 Agent 稳定运行](../stages/07-multi-agent-production.zh-Hans.md)",
