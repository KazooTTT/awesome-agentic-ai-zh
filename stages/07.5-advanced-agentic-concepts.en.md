...
When a model improves, a prompt patch or extra step may no longer be needed. Permissions, sandboxes, logs, Evals, and recovery do **not automatically become obsolete**. Test one Harness component at a time, then run the same Eval.
